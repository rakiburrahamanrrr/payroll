...
// }
if(!file_exists($payslip_dir)) {
    if (mkdir($payslip_dir, 0777, true)) {
        echo "Directory created successfully: $payslip_dir\n";
    } else {
        echo "Failed to create directory: $payslip_dir\n";
        exit;
    }
} else {
    echo "Directory already exists: $payslip_dir\n";
}
